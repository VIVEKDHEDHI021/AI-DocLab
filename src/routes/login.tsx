      ...
      <div className="flex flex-col items-center justify-center bg-background p-6 md:p-10">
        <div className="w-full max-w-[400px]">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">Sign in to your wallet.</p>

            <Button
              type="button"
              variant="outline"
              className="mt-8 w-full hover:bg-accent"
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="email" type="email" required value={email} onChange={e => { setError(null); setEmail(e.target.value); }} className="bg-surface/50" />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="password">Password</Label>
                <Input id="password" type="password" required value={password} onChange={e => { setError(null); setPassword(e.target.value); }} className="bg-surface/50" />
              </div>
