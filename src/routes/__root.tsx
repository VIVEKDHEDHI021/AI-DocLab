...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-powered document storage with summaries, tags, and instant search." },
...
function RootComponent() {
  ...
  const googleClientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || "your-client-id-here.apps.googleusercontent.com";
